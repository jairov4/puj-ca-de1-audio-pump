...
MEM_0 := system_design_onchip_memory2_0
...
$(MEM_0)_START := 0x01200000
$(MEM_0)_END := 0x01203fff
...
$(MEM_1)_HIERARCHICAL_PATH := sdram0
$(MEM_1)_WIDTH := 16
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: sdram0
sdram0: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
